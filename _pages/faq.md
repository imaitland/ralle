...
The [United Electrical, Radio and Machine Workers of America (UE)](https://www.ueunion.org/) is a democratic, rank-and-file union with a long history of fighting for workers' rights since the 1930s. UE is known for its member-driven structure and advocacy for social justice. UE represents academic workers across the country and believes that unions are for everyone.
...
1. Build an organizing team
2. Gather authorization cards from workers
3. Seek recognition from the employer
4. Hold a representation election
5. Elect union leadership
6. Negotiate a contract

## How can I get involved?

You can:
- Fill out our [interest form](http://tinyurl.com/ralle-petition) to register your interest
- Sign up for an [info session](https://forms.gle/soJMaRocy4XQvN6q7) to learn more
...
1. Elect a bargaining committee from among the membership
2. Survey members about priorities for contract negotiations
3. Negotiate a first contract with the university
4. Bring the proposed contract back to the membership for ratification
5. Once ratified, the contract goes into effect
